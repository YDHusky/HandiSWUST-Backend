...
@UtilityClass
public class Const {
    public static final String CURRENT_TERM = "2024-2025-1";
    public static final long CURRENT_TERM_LONG = 202320242;    // 2023-2024-1
    public static final long START_DATE = DateUtil.getDate("2024-9-2");
    public static final long END_DATE = DateUtil.getDate("2025-1-13");
